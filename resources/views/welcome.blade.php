       ...
       background-position: calc(100% + 400px) calc(100% + 500px);">
        ...
        <div class="max-w-5xl mx-auto text-center relative px-4 sm:px-10 mt-16">
            ...
            <p class="text-gray-400 text-lg">
                Optimize your resource management with our powerful system, designed to efficiently allocate assets, track
                usage, and enhance operational productivity. Empower your organization with smart solutions for seamless
    ...
    <div class="px-4 sm:px-10">
        ...
        <div class="mt-32 rounded-md px-4 py-12">
            <div class="grid md:grid-cols-2 justify-center items-center gap-12 max-w-7xl mx-auto">
                <div>
                    <img src="https://readymadeui.com/management-img.webp" alt="Resource Management" class="w-full mx-auto"/>
                </div>
                <div class="max-md:text-center">
                    <h2 class="md:text-4xl text-3xl font-semibold md:!leading-[50px] mb-6">
                        Our Resource Management System simplifies asset allocation and utilization for organizations of all sizes.
                    </h2>
                    <p class="text-gray-400">
                        By automating resource tracking, scheduling, and allocation, we help businesses maximize efficiency,
        ...
        <div class="mt-32 rounded-md px-4 py-12">
            <div class="grid md:grid-cols-2 justify-center items-center gap-12 max-w-7xl mx-auto">
                <div class="max-md:text-center">
                    <h2 class="md:text-4xl text-3xl font-semibold md:!leading-[50px] mb-6">
                        Optimize Resource Allocation with Smart Management
                    </h2>
                    <p class="text-gray-400">
                        Our system is designed to enhance efficiency by streamlining resource tracking, scheduling, and
                        utilization. With intelligent automation, businesses can minimize waste, boost productivity, and make
                        data-driven decisions for effective resource management.
                    </p>
                    <button type="button"
                            class="px-6 py-3.5 rounded-md text-gray-100 bg-blue-700 hover:bg-blue-800 transition-all mt-10">
                ...
                <div>
                    <img src="https://readymadeui.com/team-image.webp" alt="Resource Management" class="w-full mx-auto"/>
                </div>
            </div>
        </div>
        ...
        <div class="mt-32 max-w-7xl mx-auto">
            <div class="mb-16 max-w-2xl text-center mx-auto">
                ...
                <p class="text-gray-400">Qui elit labore in nisi dolore tempor anim laboris ipsum ad ad consequat id.
                    Dolore
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12 mt-16">
                <div class="text-center bg-[#111] px-6 py-8 rounded-2xl">
                    ...
                    <p class="text-gray-400">Never miss a payment! COMS automatically generates bills and sends timely
                        notifications to tenants for upcoming due dates</p>
                ...
                <div class="text-center bg-[#111] px-6 py-8 rounded-2xl">
                    ...
                    <p class="text-gray-400">Access real-time data on all ongoing operations, active contracts, and
                        tenant payment statuses—all in one place.</p>
                    <!-- <a href="javascript:void(0);" class="text-blue-600 inline-block mt-4 hover:underline">Learn more</a> -->
                </div>
                <div class="text-center bg-[#111] px-6 py-8 rounded-2xl">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                    ...
                    <p class="text-gray-400">Give tenants the convenience of selecting concession spaces online,
                        simplifying the application process and minimizing processing times.</p>
                    <!-- <a href="javascript:void(0);" class="text-blue-600 inline-block mt-4 hover:underline">Learn more</a> -->
                </div>
            </div>
        </div>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li><a href="javascript:void(0)"
                           class="text-gray-400 hover:text-blue-600 transition-all">Webinars</a>
                    </li>
                    <li><a href="javascript:void(0)" class="text-gray-400 hover:text-blue-600 transition-all">Ebooks</a>
                    </li>
                    <li><a href="javascript:void(0)"
                           class="text-gray-400 hover:text-blue-600 transition-all">Templates</a>
                    </li>
                    <li><a href="javascript:void(0)"
                           class="text-gray-400 hover:text-blue-600 transition-all">Tutorials</a></li>
                </ul>
            </div>
            <!-- <div>
              <h4 class="text-lg mb-6">About Us</h4>
