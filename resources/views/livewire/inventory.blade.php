                ...
                <div x-show="!isSearchOpen" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div x-show="showImportModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4 transition radius-5" style="display: none;">
                                <div class="bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-2xl shadow-2xl p-6 sm:p-8 w-full max-w-md transition">
                                    <!-- Header -->
                                    <div class="flex justify-between items-center mb-4 sm:mb-6">
                                        <h3 class="text-2xl font-bold">Import Assets from Excel</h3>
                                        <button @click="showImportModal = false" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white focus:outline-none">
                                    ...
                                    <form wire:submit.prevent="importAssets" class="space-y-6">
                                        <!-- File Input -->
                            <div>
                                <label for="importFile" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Excel File</label>
                                <input type="file" wire:model="importFile" id="importFile" accept=".xlsx,.xls,.csv"
                            ...
                            <div class="mt-2">
                                @error('importFile') 
                                    <div class="text-red-600 text-sm bg-red-50 border border-red-300 rounded-lg px-4 py-2">
                                        {{ $message }}
                                    </div>
                                @enderror
                            </div>
