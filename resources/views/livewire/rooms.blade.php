                ...
                <div class="px-4 py-4 sm:px-6 dark:bg-gray-800">
                    ...
                    <div x-show="show" x-transition:enter="transition ease-out delay-300 duration-300"
                        ...
                        @if ($currentClassroom->assetGroups->isEmpty())
                            <p class="text-gray-500 dark:text-gray-400 italic">No assets found for this classroom.</p>
                        @else
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody class="bg-white dark:bg-gray-900">
                                    @foreach ($currentClassroom->assetGroups as $assetGroup)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-600 border-t border-gray-200 dark:border-gray-700">
                ...
                <div class="px-4 py-4 sm:px-6 dark:bg-gray-800">
                    ...
                    <div x-show="show" x-transition:enter="transition ease-out delay-150 duration-300"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                <p class="mb-1"><span
                                        class="font-medium dark:text-gray-200">Capacity:</span>
                                    <span
                                        class="dark:text-gray-300">{{ $currentClassroom->capacity ?? 'N/A' }}
                                        seats</span>
                                </p>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
        <label for="modalSchoolYear" class="block text-sm font-medium mb-2 dark:text-gray-200">School Year</label>
        <x-filament::input.wrapper>
            <x-filament::input.select id="modalSchoolYear" wire:model.live="modalSelectedSchoolYear">
                <option value="">All School Years</option>
    ...
    <div>
        <label for="modalSemester" class="block text-sm font-medium mb-2 dark:text-gray-200">Semester</label>
        <x-filament::input.wrapper>
            <x-filament::input.select id="modalSemester" wire:model.live="modalSelectedSemester">
                <option value="">All Semesters</option>
                                                            ...
                                                            <table
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th
                                                                            class="w-1/5 px-3 py-2class="w-1/5 px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                                                                    Subject
                                                                                </th>
                                                                                <th
                                                                                    class="w-1/5 px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
